...
# Previous styling for Leadership Page

# <div class="employee-info">
# <img src="<%= @employee.profile_image_url %>" class="profile-pic" alt="#{@employee.first_name} #{@employee.last_name}">
# <h2><%= "#{@employee.first_name} #{@employee.last_name}" %><span class="certifications">, ASA, ABV, CFA</span></h2>
...
# <div class="employee-bio-2">
#   <p class='text-muted employee-bio'>Justin began his career in business valuation at HSSK (Houston, TX) in August 2016. His valuation work has focused primarily on Fair Market Value and Fair Value engagements, serving clients across a wide variety of industries for the purposes of estate and gift tax reporting, purchase price allocations, M&A transactions, internal planning purposes, partner buy-ins and buyouts, fairness opinions, asset-backed lending and regulatory reporting, among other purposes. Additionally, Justin has provided valuation services in support of litigation matters, including the determination of economic damages and providing expert testimony regarding the determination of lost wages.</p>

#   <p class='text-muted employee-bio'>He holds the Accredited Senior Appraiser (ASA) credential (American Society of Appraisers), the Accredited in Business Valuation (ABV) credential (American Institute of Certified Public Accountants) and the Chartered Financial Analyst® (CFA) designation awarded by the CFA Institute.</p>

#   <p class='text-muted employee-bio'>His clients have ranged from single-location family owned/operated furniture manufacturers to large, multi-national bio/pharmaceutical companies, capital intensive oilfield machinery & equipment manufacturers to service oriented enterprises such as architectural/engineering firms and direct-to-consumer housewares brands, and quite a few industries in between.</p>

#   <p class="text-muted employee-bio">Outside of his employment as a business valuation specialist, Justin occasionally speaks at University of Houston functions, promoting the university's MS Finance and MBA programs, and discussing careers in realm of financial analysis and business valuation more generally.</p>

#   <p class="text-muted employee-bio">Before joining HSSK, Justin worked as a Midstream Analyst for Hart Energy (now Stratas Advisors) and as the Senior Financial Analyst for the U.S.-based transportation company, Trimac Transportation. Prior to his work in the field of finance and analysis, Justin provided engineering and graphic design services, with a focus on oil & gas and power-generation facilities.</p>
# </div>
# </div>
