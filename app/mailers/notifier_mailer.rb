class NotifierMailer < ApplicationMailer
  ...
  def send_signup_email(email, name)
    mail(
      to: email,
      subject: "Insightful Valuations LLC - Thank you #{name}, you have successfully created account!",
  ...
  def contact_form_receipt(name, email)
    mail(
      to: email,
      subject: "Insightful Valuations LLC - Thank you #{name} for your message!",
